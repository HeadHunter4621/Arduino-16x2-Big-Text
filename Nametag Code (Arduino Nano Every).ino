...
byte d[8] = { B11111, B11111, B11111, B11111, B00000, B00000, B00000, B00000 };
byte e[8] = { B11100, B11100, B11100, B11100, B11111, B11111, B11111, B11111 };
byte f[8] = { B00111, B00111, B00111, B00111, B11111, B11111, B11111, B11111 };
byte g[8] = { B00111, B00111, B00111, B00111, B00111, B00111, B00111, B00111 };
byte h[8] = { B00000, B00000, B00000, B00000, B11111, B11111, B11111, B11111 };

int letterSpace = 0;

int letterA[4] = {0, 1, 0, 1};
int letterB[4] = {4, 7, 2, 1};
int letterC[4] = {0, 6, 2, 7};
int letterD[4] = {4, 1, 4, 3};
int letterE[4] = {1, 3, 2, 7};
int letterF[4] = {0, 6, 0, 6};
int letterG[4] = {0, 6, 2, 3};
int letterH[4] = {2, 3, 0, 1};
int letterI[4] = {1, 0, 2, 3};
int letterJ[4] = {4, 7, 4, 3};
int letterK[4] = {2, 0, 0, 2};
int letterL[4] = {4, 7, 2, 7};
